    ...
    <div class="p-8 border-b-[.5px] py-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2  gap-4 py-10">
            ...
            <div>
                ...
                <p class="text-gray-500">
                    Curious minds, bright ideas, and boundless energy — our students bring life to the campus every day. With opportunities to lead, create, and grow, they embody the spirit of learning in every corner of the school.
                </p>
            </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2  gap-4 py-10">
            <div>
                ...
                <p class="text-gray-500">
                    Though they've stepped beyond our gates, our alumni remain deeply connected. As achievers across fields and continents, they carry forward the values and vision of our school - and often give back to guide those who follow.
                </p>
            </div>
            <div class="flex flex-col">
                <div class="flex justify-center">
